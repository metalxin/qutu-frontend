 ...
 */
package cn.sdstudio.qutu.common.core.jackson;
...
public class QutuJavaTimeModule extends SimpleModule {

	/**
	 * qutuJavaTimeModule构造函数，用于初始化时间序列化和反序列化规则
	 */
	public QutuJavaTimeModule() {
