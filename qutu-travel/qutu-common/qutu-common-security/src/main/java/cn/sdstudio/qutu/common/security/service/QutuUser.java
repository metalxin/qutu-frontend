 ...
 * @date 2025/05/31
 */
public class QutuUser extends User implements OAuth2AuthenticatedPrincipal {
	...
	public QutuUser(Long id, Long deptId, String username, String password, String phone, boolean enabled,
