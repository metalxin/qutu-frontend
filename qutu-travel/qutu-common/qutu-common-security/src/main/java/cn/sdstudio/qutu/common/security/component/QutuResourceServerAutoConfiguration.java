...
public class QutuResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public QutuBearerTokenExtractor qutuBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
		return new QutuBearerTokenExtractor(urlProperties);
	}
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new QutuCustomOpaqueTokenIntrospector(authorizationService);
	}
