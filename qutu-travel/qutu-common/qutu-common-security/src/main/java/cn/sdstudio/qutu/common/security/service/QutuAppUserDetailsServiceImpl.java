...
public class QutuAppUserDetailsServiceImpl implements QutuUserDetailsService {
	...
	public UserDetails loadUserByUsername(String phone) {
		...
		if (cache != null && cache.get(phone) != null) {
			return (QutuUser) cache.get(phone).get();
		}
	...
	/**
	 * 根据用户信息加载用户详情
	 * @param qutuUser 用户信息对象
	 * @return 用户详情
	 */
	@Override
	public UserDetails loadUserByUser(QutuUser qutuUser) {
		return this.loadUserByUsername(qutuUser.getPhone());
	}
