...
public class QutuResourceServerConfiguration {
	 ...
	 * qutuBearerToken提取器
	 */
	private final QutuBearerTokenExtractor qutuBearerTokenExtractor;
		...
		http.authorizeHttpRequests(authorizeRequests -> authorizeRequests.requestMatchers(permitMatchers)
			...
			.oauth2ResourceServer(
					oauth2 -> oauth2.opaqueToken(token -> token.introspector(customOpaqueTokenIntrospector))
						...
						.bearerTokenResolver(qutuBearerTokenExtractor))
