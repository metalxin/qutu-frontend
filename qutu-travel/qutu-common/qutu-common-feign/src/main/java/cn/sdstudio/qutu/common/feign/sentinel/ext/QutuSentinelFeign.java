...
package cn.sdstudio.qutu.common.feign.sentinel.ext;
...
/**
 * 支持自动降级注入的Feign构建器，重写
 * @link com.alibaba.cloud.sentinel.feign.SentinelFeign}
 *
 * @author lengleng
 * @date 2025/05/31
 */
public final class QutuSentinelFeign {

	private QutuSentinelFeign() {

	}

	public static QutuSentinelFeign.Builder builder() {
		return new QutuSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public QutuSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new QutuSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new QutuSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new QutuSentinelInvocationHandler(target, dispatch);
				}
