package cn.sdstudio.qutu.common.feign.core;
...
/**
 * qutuFeign 内部请求拦截器，用于处理 Feign 请求的 Token 校验
 *
 * @author lengleng
 * @date 2025/05/31
 */
public class QutuFeignInnerRequestInterceptor implements RequestInterceptor, Ordered {
