 ...
 */
@Slf4j
public class QutuSentinelInvocationHandler implements InvocationHandler {
	...
	QutuSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			QutuSentinelInvocationHandler other = (QutuSentinelInvocationHandler) obj;
