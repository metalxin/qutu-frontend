...
package cn.sdstudio.qutu.common.log.aspect;

import cn.hutool.core.util.StrUtil;
import cn.sdstudio.qutu.common.core.util.SpringContextHolder;
import cn.sdstudio.qutu.common.log.event.SysLogEvent;
import cn.sdstudio.qutu.common.log.event.SysLogEventSource;
import cn.sdstudio.qutu.common.log.util.LogTypeEnum;
...
public class SysLogAspect {
	...
	@SneakyThrows
	public Object around(ProceedingJoinPoint point, cn.sdstudio.qutu.common.log.annotation.SysLog sysLog) {
