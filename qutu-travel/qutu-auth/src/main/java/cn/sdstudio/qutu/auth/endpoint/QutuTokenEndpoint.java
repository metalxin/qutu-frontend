...
import cn.sdstudio.qutu.admin.api.feign.RemoteClientDetailsService;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import cn.sdstudio.qutu.admin.api.entity.SysOauthClientDetails;
import cn.sdstudio.qutu.admin.api.vo.TokenVo;
...
import cn.sdstudio.qutu.common.core.util.RetOps;
...
import cn.sdstudio.qutu.common.security.util.OAuth2ErrorCodesExpand;
import cn.sdstudio.qutu.common.security.util.OAuthClientException;
...
public class QutuTokenEndpoint {

	private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new OAuth2AccessTokenResponseHttpMessageConverter();

	private final AuthenticationFailureHandler authenticationFailureHandler = new QutuAuthenticationFailureEventHandler();
